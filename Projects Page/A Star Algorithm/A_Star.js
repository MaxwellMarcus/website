...
var screen_height = window.innerHeight-window.innerHeight/25;
...
function update(){
  ...
  c.fillText('Scroll for more info',screen_width/2,screen_height-screen_height/7)
